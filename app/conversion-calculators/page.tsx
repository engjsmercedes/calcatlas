...
const hub = subtopicHubs.find((item) => item.slug === "conversion-calculators")!;
...
export default function Page() {
  return (
    <>
      <StructuredData data={{ "@context": "https://schema.org", "@type": "CollectionPage", name: hub.title, description: hub.shortDescription, url: absoluteUrl("/conversion-calculators") }} />
